...
この public beta は、native installer、署名済み desktop distribution、OS-level sandbox enforcement、enforcement-complete classification / MAC、この Free v0.1 public beta の明示的範囲外の機能・統治を主張しません。
