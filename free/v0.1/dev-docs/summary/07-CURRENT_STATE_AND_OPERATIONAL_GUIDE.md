...
2. then-current `public/free-v0.1/free/v0.1/0` は historical GitHub publication branch staging root として扱う。2026-04-26 JST 時点の public repository model は root repository `ancient0328/CYRUNE`、latest surface `main`、immutable snapshot tag `v0.1.0` である
...
6. current operational roadmap が採用する implementation completion conditions は stand-alone complete root、then-current GitHub publication branch root、tracked GitHub branch、GitHub release carrier、public checkout preparation の全 operational surface である。current public repo authority は `main` + `v0.1.0` snapshot model に更新済みである
...
6. separate future scope `GPC` の current operational roadmap authority は `20260423-gpc-operational-completion-implementation-roadmap.md` と `20260423-gpc-operational-completion-test-roadmap.md` であり、stand-alone complete root、then-current GitHub publication branch root、tracked GitHub branch、GitHub release carrier、public checkout preparation の全 operational surface を user-fixed 2 目的の達成面として扱った。current public repo authority は `main` + `v0.1.0` snapshot model に更新済みである
...
8. separate future scope `GPC` の current operational completion conditions は stand-alone complete root、then-current GitHub publication branch root、tracked GitHub branch、GitHub release carrier、public checkout preparation の全 operational surface であった。current public repo authority は `main` + `v0.1.0` snapshot model に更新済みである
